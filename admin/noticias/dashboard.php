        ...
        <form method="post" enctype="multipart/form-data" class="form-container">
            ...
            <div class="form-container full" style="margin-top: 20px;">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                    <div class="form-group">
                        <label for="link">🔗 Link al artículo original <small style="font-weight:400;color:#888;">(aparece como "Leer Completo")</small></label>
                        <input type="url" id="link" name="link" placeholder="https://ejemplo.com/articulo-completo">
                    </div>
                    <div class="form-group">
                        <label for="youtube_link">🎥 Link de YouTube <small style="font-weight:400;color:#888;">(video de la noticia, opcional)</small></label>
