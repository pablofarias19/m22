...
$defaultIcons = [
    ...
    'agente_inpi'    => ['emoji' => '📋',  'color' => '#6366f1'],
    ...
    // Transporte
    'transporte_envios' => ['emoji' => '📦', 'color' => '#2980b9'],
    'transporte_pasajeros' => ['emoji' => '🚌', 'color' => '#27ae60'],
    'transporte_carga' => ['emoji' => '🚛', 'color' => '#e67e22'],
    'transportista'  => ['emoji' => '🚚',  'color' => '#7f8c8d'],
    'logistica'      => ['emoji' => '🏭',  'color' => '#2c3e50'],
    'flota'          => ['emoji' => '🚐',  'color' => '#3498db'],
    // Educación & Turismo
    ...
    // Arte & Cultura
    'obra_de_arte'   => ['emoji' => '🎭',  'color' => '#8e44ad'],
    'musico'         => ['emoji' => '🎸',  'color' => '#e74c3c'],
    'cantante'       => ['emoji' => '🎤',  'color' => '#e91e63'],
    'bailarin'       => ['emoji' => '💃',  'color' => '#9b59b6'],
    'actor'          => ['emoji' => '🎭',  'color' => '#8e44ad'],
    'actriz'         => ['emoji' => '🎭',  'color' => '#e91e63'],
    'director_artistico' => ['emoji' => '🎬', 'color' => '#2c3e50'],
    'guionista'      => ['emoji' => '📝',  'color' => '#3498db'],
    'escenografo'    => ['emoji' => '🖼️', 'color' => '#16a085'],
    'fotografo_artistico' => ['emoji' => '📷', 'color' => '#34495e'],
    'productor_artistico' => ['emoji' => '🎙️', 'color' => '#6c5ce7'],
    'maquillador'    => ['emoji' => '💄',  'color' => '#e91e63'],
    'pintor'         => ['emoji' => '🎨',  'color' => '#e67e22'],
    'poeta'          => ['emoji' => '📜',  'color' => '#7f8c8d'],
    'musicalizador'  => ['emoji' => '🎵',  'color' => '#8e44ad'],
    'editor_grafico' => ['emoji' => '🖥️', 'color' => '#2980b9'],
    'asistente_artistico' => ['emoji' => '🤝', 'color' => '#27ae60'],
    // Otros
